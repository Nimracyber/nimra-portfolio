      ...
      <nav style={{
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '2rem', fontSize: '0.9rem', fontWeight: '600', letterSpacing: '0.5px' }}>
            ...
            <a href="#skills" style={{ color: '#0f172a', textDecoration: 'none' }}>SKILLS</a>
            <a href="#qualifications" style={{ color: '#0f172a', textDecoration: 'none' }}>QUALIFICATIONS</a>
          </div>
        </div>
      </nav>
      ...
      <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        <section id="home" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '3rem', padding: '4rem 0 6rem 0' }}>
          <div style={{ flex: '1', minWidth: '300px' }}>
            <h4 style={{ color: '#0f172a', fontSize: '1.5rem', fontWeight: '600', margin: '0 0 0.5rem 0' }}>Hello, I'm</h4>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <a href="#skills" style={{ backgroundColor: '#00bcd4', color: '#ffffff', padding: '0.8rem 2rem', borderRadius: '4px', textDecoration: 'none', fontWeight: '700', fontSize: '0.95rem' }}>View Expertise</a>
              <a href="#qualifications" style={{ border: '2px solid #0f172a', color: '#0f172a', padding: '0.8rem 2rem', borderRadius: '4px', textDecoration: 'none', fontWeight: '700', fontSize: '0.95rem' }}>Qualifications</a>
            </div>
          </div>
          
          {/* New Professional Girl Graphic */}
          <div style={{ flex: '1', display: 'flex', justifyContent: 'center', minWidth: '300px' }}>
            <img 
              src="https://img.freepik.com/free-photo/stylish-confident-businesswoman-smiling-suit_176420-21017.jpg?t=st=1739958742~exp=1739962342~hmac=59eb568fca95ebcc0d68af181be39dbd8c97483669bd7532d00f9f303250b73c&w=1380" // Example professional image URL
        ...
        <section id="about" style={{ padding: '5rem 0', borderTop: '1px solid #e2e8f0' }}>
          <h2 style={{ fontSize: '2.2rem', fontWeight: '700', marginBottom: '2rem', textAlign: 'center' }}>
            About <span style={{ color: '#00bcd4' }}>Me</span>
          </h2>
          <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '3rem', textAlign: 'center' }}>
            <p style={{ color: '#1e293b', fontSize: '1.15rem', lineHeight: '1.8', margin: 0 }}>
        ...
        <section id="skills" style={{ padding: '5rem 0', borderTop: '1px solid #e2e8f0' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '2.5rem', textAlign: 'center' }}>
            ...
            <div>
              ...
              <span style={{ color: '#00bcd4', fontWeight: '700', fontSize: '1.4rem' }}>90%</span>
            </div>
            <div>
              <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>🐍</div>
              <h3 style={{ fontSize: '1.2rem', fontWeight: '600', marginBottom: '0.5rem' }}>Python Programming</h3>
              <span style={{ color: '#00bcd4', fontWeight: '700', fontSize: '1.4rem' }}>88%</span>
            </div>
            <div>
              <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>🔍</div>
              <h3 style={{ fontSize: '1.2rem', fontWeight: '600', marginBottom: '0.5rem' }}>SEO Optimization</h3>
              <span style={{ color: '#00bcd4', fontWeight: '700', fontSize: '1.4rem' }}>85%</span>
            </div>
          </div>
        </section>

        {/* REVISED EDUCATION & CERTIFICATIONS INFRASTRUCTURE */}
        <section id="qualifications" style={{ padding: '5rem 0', borderTop: '1px solid #e2e8f0' }}>
          <h2 style={{ fontSize: '2.2rem', fontWeight: '700', marginBottom: '4rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ backgroundColor: '#ffffff', border: '1px solid #00bcd4', borderRadius: '8px', padding: '2rem' }}>
                ...
                <p style={{ color: '#475569', margin: 0, fontSize: '0.95rem' }}>University of Gujrat</p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                <div>
                  <h5 style={{ margin: '0 0 0.25rem 0', fontSize: '1.05rem', color: '#0f172a' }}>AI &amp; Robotics Certification</h5>
                  <p style={{ margin: 0, fontSize: '0.85rem', color: '#64748b' }}>NAVTTC Centre of Excellence, Islamabad</p>
                </div>
                <div>
                  <h5 style={{ margin: '0 0 0.25rem 0', fontSize: '1.05rem', color: '#0f172a' }}>Advanced Data Analytics</h5>
                  <p style={{ margin: 0, fontSize: '0.85rem', color: '#64748b' }}>Chief Minister Punjab Skill Development Initiative</p>
                </div>
                <div>
                  <h5 style={{ margin: '0 0 0.25rem 0', fontSize: '1.05rem', color: '#0f172a' }}>AI, Python &amp; SEO Frameworks</h5>
                  <p style={{ margin: 0, fontSize: '0.85rem', color: '#64748b' }}>DigiSkills Training Program</p>
                </div>
                <div>
                  <h5 style={{ margin: '0 0 0.25rem 0', fontSize: '1.05rem', color: '#0f172a' }}>Certified Freelancing Professional &amp; MS Office</h5>
        ...
        {/* WORK EXPERIENCE */}
        <section id="experience" style={{ padding: '5rem 0', borderTop: '1px solid #e2e8f0' }}>
          ...
          <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '2.5rem' }}>
        ...
        {/* SECURE CLEAN FOOTER */}
        <footer style={{ borderTop: '1px solid #e2e8f0', paddingTop: '2.5rem', marginTop: '5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem', fontSize: '0.9rem', color: '#64748b' }}>
